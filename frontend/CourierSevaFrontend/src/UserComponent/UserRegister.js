...
const UserRegister = () => {
  ...
  useEffect(() => {
    if (document.URL.indexOf("customer") != -1) {
      ...
      user.role = "Delivery";
    } else if (document.URL.indexOf("courier") != -1) {
      user.role = "Courier";
    }
  }, []);
      ...
      .then((result) => {
        ...
        result.json().then((res) => {
          if (res.success) {
            ...
            if (document.URL.indexOf("delivery") != -1) {
              setTimeout(() => {
                navigate("/courier/delivery-person/all");
              }, 1000);
            } else {
              setTimeout(() => {
                navigate("/user/login");
      ...
      <div className="mt-2 d-flex aligns-items-center justify-content-center ms-2 me-2 mb-2">
        ...
        >
          <div className="container-fluid">
            ...
            >
              <h5 className="card-title">User Register Here!!!</h5>
            </div>
